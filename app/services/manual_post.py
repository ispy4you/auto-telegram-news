...
не с чем, а отправлять его в канал без ведома автора тем более не надо. Но
нормализованный текст и хеш у него заполнены — чтобы та же новость, пришедшая
позже из канала, узналась как повтор.
"""
