...
- Интеграция с **Timeweb AI Gateway** (OpenAI-совместимый endpoint) — легко подключить любой
  OpenAI-совместимый API.
- Правила для AI собираются анкетой или пишутся текстом, хранятся в базе и правятся прямо в админке;
  там же кнопка «Проверить на свежей новости» и справка о том, что уходит в модель помимо правил.
